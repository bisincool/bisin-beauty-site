(function () {
  ...
  var japaneseToChineseCopy = [
    ...
    ['FEATURED CASE', '精选案例'],
    ['Featured Case', '精选案例'],
    ['後ろ姿でわかる、背中・腰まわりの変化。', '从背影看得出的背部和腰周变化。'],
    ['100カップチャレンジ経過症例。顔出しではなく背中・腰まわりのライン変化が見える写真に差し替え、初めての方にも実感値が伝わりやすい構成にしました。', '100杯挑战阶段案例。不露脸也能看到背部和腰周线条变化，第一次咨询的人也更容易判断真实效果。'],
    ['脂肪冷冻瘦身は回数を重ねながら、約1ヶ月かけてラインの変化を見ていく施術です。温めてから冷却する流れで、夏前のサイズダウン相談にもおすすめです。', '脂肪冷冻瘦身适合按次数持续护理，通常会在约1个月左右观察线条变化。先温热再冷冻的流程，也适合夏天前想咨询尺寸管理的人。'],
    ['脂肪冷却は回数を重ねながら、約1ヶ月かけてラインの変化を見ていく施術です。温めてから冷却する流れで、夏前のサイズダウン相談にもおすすめです。', '脂肪冷冻瘦身适合按次数持续护理，通常会在约1个月左右观察线条变化。先温热再冷冻的流程，也适合夏天前想咨询尺寸管理的人。'],
    ['HotPepper掲載症例を見る', '查看 HotPepper 案例'],
    ['100カップチャレンジ / 背中・腰まわり', '100杯挑战 / 背部・腰周'],
    ['HotPepper掲載内容より要約', '根据 HotPepper 发布内容整理'],
    ['50代女性 ／ 7回施術 ／ 食事制限なし', '50多岁女性 / 7次护理 / 无需节食'],
    ['「半信半疑でしたが、7回通ったらウエストが10cmも細くなって自分でも驚きました。食事を変えたわけでもないのに、服のサイズが本当に変わりました。」', '“一开始半信半疑，护理7次后腰围细了10cm，连自己都很惊讶。没有刻意改变饮食，衣服尺寸真的变了。”'],
    ['「産後のお腹が全然戻らなくて悩んでいたのに、5回で別人みたいになりました。」', '“产后腹部一直恢复不了，护理5次后线条变化很明显。”'],
    ['「背中は自分では見えないから気になりながら放置していたけど、相談して本当によかった。」', '“背部自己看不到所以一直放着没处理，实际咨询后觉得真的来对了。”'],
    ['「運動が続かない私でも、通うだけで結果が出るのがありがたくて、今も続けています。」', '“我很难坚持运动，只要定期来护理也能看到变化，所以现在还在继续。”'],
    ['男性のお腹まわりも、正面と横からの写真で変化を確認。ぽっこり感やウエストラインが気になる方の相談材料に。', '男性腹部也可以通过正面和侧面照片确认变化。适合在意小腹感和腰线的人先做咨询参考。'],
    ['二の腕や背中もすっきり見えるようになり、体型維持のために通いたいという口コミ傾向。', '上臂和背部也更显清爽，不少反馈表示想继续护理来维持体型。'],
    ['お腹、下腹、太ももなどを計画的にケア。短期集中で見た目の変化を狙う方に。', '腹部、下腹、大腿等可以有计划地护理。适合想短期集中管理外观变化的人。'],
    ['※ 効果には個人差があります。掲載データはお客様のご同意を得た実測値です。食事制限・激しい運動は行っていません。', '※ 效果因人而异。页面数据为获得顾客同意后发布的实测值，未进行节食或高强度运动。'],
    ['お腹-9cm・ウエスト-7cm・下腹-9.5cm。温めてから冷却する集中ケア。', '腹部-9cm、腰围-7cm、下腹-9.5cm。先温热再冷冻的集中护理。'],
    ['サウナドームで身体を温めてから脂肪冷冻瘦身へ。初めてでも受けやすい流れとして紹介します。', '先用桑拿舱温热身体，再进行脂肪冷冻瘦身。第一次体验也容易接受。'],
    ['サウナドームで身体を温めてから脂肪冷却へ。初めてでも受けやすい流れとして紹介します。', '先用桑拿舱温热身体，再进行脂肪冷冻瘦身。第一次体验也容易接受。'],
    ['初めての脂肪冷冻瘦身。効果はいつ頃から？来店前に知りたいこと。', '第一次做脂肪冷冻瘦身，什么时候开始有感觉？来店前想知道的事。'],
    ['初めての脂肪冷却。効果はいつ頃から？来店前に知りたいこと。', '第一次做脂肪冷冻瘦身，什么时候开始有感觉？来店前想知道的事。'],
    ['効果の見え方は3週間から1ヶ月ほどを目安に、施術後の過ごし方まで丁寧に案内します。', '变化通常以3周到1个月为参考，护理后的注意事项也会细心说明。'],
    ['天神南駅徒歩3分。仕事帰りにも通いやすい脂肪冷冻瘦身専門サロン。', '天神南站步行3分钟。下班后也方便来的脂肪冷冻瘦身专门沙龙。'],
    ['天神南駅徒歩3分。仕事帰りにも通いやすい脂肪冷却専門サロン。', '天神南站步行3分钟。下班后也方便来的脂肪冷冻瘦身专门沙龙。'],
    ['都度払い、初回体験、HotPepper予約、微信相談まで、迷わず予約できる導線をまとめました。', '单次付费、初次体验、HotPepper预约、微信咨询都整理好了，可以更安心地预约。'],
    ['都度払い、初回体験、HotPepper予約、LINE相談まで、迷わず予約できる導線をまとめました。', '单次付费、初次体验、HotPepper预约、微信咨询都整理好了，可以更安心地预约。'],
    ['HotPepper Beauty掲載口コミより要約', '根据 HotPepper Beauty 口コミ整理'],
    ['HotPepper掲載より', '根据 HotPepper 发布内容'],
    ['口コミから整理', '根据口コミ整理'],
    ['LINEでお問い合わせください', '请通过微信咨询'],
    ['微信でお問い合わせください', '请通过微信咨询'],
    ['ご予約・お問い合わせはLINEがおすすめ！', '预约和咨询推荐使用微信！'],
    ['ご予約・お問い合わせは微信がおすすめ！', '预约和咨询推荐使用微信！'],
    ['LINEで予約・相談', '微信预约・咨询'],
    ['微信で予約・相談', '微信预约・咨询'],
    ['LINEで予約する', '微信预约'],
    ['微信で予約する', '微信预约'],
    ...
    ['LINEで事前相談', '微信事前咨询'],
    ['微信で事前相談', '微信事前咨询'],
    ['LINEでデザイン相談もできます', '也可以通过微信咨询美甲设计'],
    ['微信でデザイン相談もできます', '也可以通过微信咨询美甲设计'],
    ['まずはLINEでデザイン相談を', '先通过微信咨询美甲设计'],
    ['まずは微信でデザイン相談を', '先通过微信咨询美甲设计'],
    ['「こんなデザインにしたい」というイメージ画像をLINEで送っていただくだけでOK。お気軽にご相談ください。', '把“想做这样的设计”的参考图片通过微信发来即可。欢迎轻松咨询。'],
    ['「こんなデザインにしたい」というイメージ画像を微信で送っていただくだけでOK。お気軽にご相談ください。', '把“想做这样的设计”的参考图片通过微信发来即可。欢迎轻松咨询。'],
    ['デザインのご相談もLINEでOK。希望日時をお知らせください。', '设计也可以先用微信咨询。请告诉我们希望日期和时间。'],
    ['デザインのご相談も微信でOK。希望日時をお知らせください。', '设计也可以先用微信咨询。请告诉我们希望日期和时间。'],
    ['ネイルサービスは小郡店でご対応しています。脂肪冷冻瘦身と組み合わせて、同日施術も可能です。', '美甲服务在小郡店提供。也可以和脂肪冷冻瘦身安排同日护理。'],
    ['ネイルサービスは小郡店でご対応しています。脂肪冷却と組み合わせて、同日施術も可能です。', '美甲服务在小郡店提供。也可以和脂肪冷冻瘦身安排同日护理。'],
    ['詳細はLINEにてご確認いただけます。', '详情可通过微信确认。'],
    ['詳細は微信にてご確認いただけます。', '详情可通过微信确认。'],
    ['初めての方でも安心。来店からお帰りまでの流れをご説明します。', '第一次来也安心。我们会说明从到店到结束的流程。'],
    ['初回体験価格は各店舗で初めてご利用の方限定。価格は予告なく変更の場合があります。', '初次体验价格限首次使用各店铺服务的客人。价格可能不经预告调整。'],
    ['1部位。まず試したい方の入口プラン。', '1个部位。适合想先试一次的入门方案。'],
    ['2部位まとめてケア。お腹＋背中など。', '2个部位一起护理，例如腹部＋背部。'],
    ['温冷ケア。初回から選ばれる定番プラン。', '温热冷冻护理。第一次也容易选择的标准方案。'],
    ['温冷ケアで満足度の高い体感へ。', '通过温热冷冻护理，带来更完整的体感。'],
    ['脂肪冷冻瘦身が初めてで、冷たさや吸引感を確認したい方に。', '适合第一次做脂肪冷冻瘦身、想确认冷感和吸附感的人。'],
    ['脂肪冷却が初めてで、冷たさや吸引感を確認したい方に。', '适合第一次做脂肪冷冻瘦身、想确认冷感和吸附感的人。'],
    ['予約メニューに迷う場合：', '不知道预约哪个项目时：'],
    ['HotPepperでは気になるプランを選び、当日カウンセリングで部位やカップ数を相談できます。', '可先在 HotPepper 选择在意的方案，到店当天再咨询部位和杯数。'],
    ['初めての方が不安になりやすい「何をされるのか」「どれくらい時間がかかるのか」を来店前に確認できます。', '第一次来容易担心“会做什么”“需要多久”，来店前即可先确认。'],
    ['HotPepperまたはLINEから予約。迷う場合は希望部位だけ伝えてください。', '通过 HotPepper 或微信预约。不确定时，只要告诉我们想改善的部位即可。'],
    ['HotPepperまたは微信から予約。迷う場合は希望部位だけ伝えてください。', '通过 HotPepper 或微信预约。不确定时，只要告诉我们想改善的部位即可。'],
    ['気になる部位、体質、目標を確認し、無理のないプランを提案します。', '确认在意部位、体质和目标后，建议不勉强的方案。'],
    ['サウナドームで温め、脂肪冷冻瘦身へ。冷たさや吸引感は声をかけながら調整します。', '先用桑拿舱温热，再进行脂肪冷冻瘦身。冷感和吸附感会边确认边调整。'],
    ['サウナドームで温め、脂肪冷却へ。冷たさや吸引感は声をかけながら調整します。', '先用桑拿舱温热，再进行脂肪冷冻瘦身。冷感和吸附感会边确认边调整。'],
    ['施術しやすい着替えをご用意します。普段着で来店できます。', '店内会准备方便护理的换洗衣物，穿平时衣服来即可。'],
    ['お腹・背中・腰まわりなど、男性の脂肪冷冻瘦身相談にも対応しています。', '腹部、背部、腰周等男性脂肪冷冻瘦身咨询也可对应。'],
    ['お腹・背中・腰まわりなど、男性の脂肪冷却相談にも対応しています。', '腹部、背部、腰周等男性脂肪冷冻瘦身咨询也可对应。'],
    ['来店前に口コミ・症例・施術の流れをまとめて確認できます。', '来店前可以先集中确认口コミ、案例和护理流程。'],
    ['施術中は冷たさや軽い引っ張り感がありますが、痛みはほとんどありません。施術後の赤みや一時的なむくみが出ることがありますが、ダウンタイムはほぼなく、そのまま日常生活に戻れます。', '护理中会有冷感和轻微拉扯感，但基本不会疼。护理后可能有短暂泛红或浮肿，几乎没有恢复期，可照常生活。'],
    ['個人差がありますが、3〜5回で変化を実感される方が多いです。施術後2〜3ヶ月かけて定着するため、継続することでより高い効果が期待できます。', '因人而异，很多人在3到5次左右开始感受到变化。护理后会在2到3个月内逐渐稳定，持续护理更容易期待效果。'],
    ['必須ではありません。掲載している症例データも食事制限・激しい運動なしの実測値です。ただし施術後のホームケアについてはスタッフからアドバイスしています。', '不是必须。页面案例数据也是未节食、未高强度运动的实测值。护理后的居家护理会由工作人员提供建议。'],
    ['お腹・背中・太もも・二の腕・脇腹などに対応しています。カウンセリングで気になる部位をお伝えいただければ、最適なプランをご提案します。', '腹部、背部、大腿、上臂、侧腰等都可对应。咨询时告诉我们在意部位，会建议合适方案。'],
    ['初めてで迷う場合は、まず気になる部位を基準に選んでください。お試しなら1CUP/2CUP、見た目の変化を狙うならサウナ×脂肪冷冻瘦身4cup、複数部位なら8cupがおすすめです。当日のカウンセリングで調整できます。', '第一次不知道怎么选时，先以在意部位为基准。想体验可选1CUP/2CUP，想看外观变化可选桑拿×脂肪冷冻瘦身4cup，多个部位推荐8cup。当天咨询时可调整。'],
    ['初めてで迷う場合は、まず気になる部位を基準に選んでください。お試しなら1CUP/2CUP、見た目の変化を狙うならサウナ×脂肪冷却4cup、複数部位なら8cupがおすすめです。当日のカウンセリングで調整できます。', '第一次不知道怎么选时，先以在意部位为基准。想体验可选1CUP/2CUP，想看外观变化可选桑拿×脂肪冷冻瘦身4cup，多个部位推荐8cup。当天咨询时可调整。'],
    ['特別な準備は不要です。施術前後は水分をしっかり取り、直前の重い食事は控えめがおすすめです。服装は普段着で問題ありません。', '不需要特别准备。护理前后建议多补充水分，护理前避免过重饮食。穿平时衣服来即可。'],
    ['後ろ姿', '背影'],
    ['100カップ', '100杯'],
    ['4回後', '4次后'],
    ['チャレンジ経過', '挑战经过'],
    ...
    ['脂肪冷冻瘦身症例', '脂肪冷冻瘦身案例'],
    ['脂肪冷却症例', '脂肪冷冻瘦身案例'],
    ['脂肪冷冻瘦身メニューを見る', '查看脂肪冷冻瘦身项目'],
    ['脂肪冷却メニューを見る', '查看脂肪冷冻瘦身项目'],
    ['効果時期とよくある質問', '效果时间与常见问题'],
    ['天神店のアクセス', '天神店交通'],
    ['定休日', '休息日'],
    ['不定休（LINEにてご確認ください）', '不定休（请通过微信确认）'],
    ['不定休（微信にてご確認ください）', '不定休（请通过微信确认）'],
    ['来店・カウンセリング', '到店・咨询'],
    ['カウンセリング', '咨询'],
    ['施術回数', '护理次数'],
    ['施術ベッド', '护理床'],
    ...
    ['人気No.2', '人气No.2'],
    ['初回¥3,300', '初次¥3,300'],
    ['しっかり変化を狙うなら', '想认真追求变化的话'],
    ['予約', '预约'],
    ['服装', '服装'],
    ['男性の相談', '男性咨询'],
    ['施術前の安心材料', '护理前的安心参考'],
    ['痛みはありますか？', '会痛吗？'],
    ['何回くらいで変化が出ますか？', '大概几次会有变化？'],
    ['食事制限は必要ですか？', '需要节食吗？'],
    ['どの部位に施術できますか？', '可以护理哪些部位？'],
    ['どのメニューを選べばいいですか？', '应该选择哪个项目？'],
    ['男性も受けられますか？', '男性也可以做吗？'],
    ['来店前に準備することはありますか？', '来店前需要准备什么吗？'],
    ['まずは1回体験 ¥3,300〜', '先体验1次 ¥3,300起'],
    ['体験を相談する', '咨询体验'],
    ['人気プランを予約', '预约人气方案'],
    ['詳細を見る', '查看详情'],
    ['詳細を確認する', '确认详情'],
    ...
    ['天神店で予約する', '预约天神店'],
    ['小郡店で予約する', '预约小郡店'],
    ['天神店をHotPepperで予約', '用 HotPepper 预约天神店'],
    ['小郡店をHotPepperで予約', '用 HotPepper 预约小郡店'],
    ['天神店を予約', '预约天神店'],
    ['小郡店を予約', '预约小郡店'],
    ['Google マップで見る', '查看 Google 地图'],
    ['来店前に確認', '来店前确认'],
    ['続きを見る', '查看详情'],
    ['お腹周り', '腹部周围'],
    ['お腹まわり', '腹部周围'],
    ...
    ['体質', '体质'],
    ['目標', '目标'],
    ['ご预约・咨询请使用WXがおすすめ！', '预约和咨询推荐使用微信！'],
    ['ご预约・咨询请使用WXが便利です', '预约和咨询用微信更方便'],
    ['WXで無料咨询', '微信免费咨询'],
    ['WXで部位・予算・通える頻度をご咨询ください。', '请通过微信告诉我们想改善的部位、预算和可来店频率。'],
    ['WX咨询', '微信咨询'],
    ['WXで咨询', '微信咨询'],
    ['WXで', '用微信'],
    ['ご预约', '预约'],
    ...
    ['マップ', '地图'],
    ['ロフト', 'LOFT'],
    ['ホテルニューオータニ博多', 'Hotel New Otani Hakata'],
    ['ローソン', 'Lawson'],
    ['サニー', 'Sunny'],
    ['ファミリーマート', 'FamilyMart'],
    ['セブンイレブン', '7-Eleven'],
