(function () {
  ...
  var copy = {
    ...
    cn: {
      htmlLang: 'zh-CN',
      label: '语言',
      title: 'Coolspa - 冻脂 & 美甲沙龙',
      summaryTitle: 'Coolspa 冻脂 & 美甲沙龙',
      summaryText: '在福冈天神 / 小郡，可咨询冻脂、美甲护理与预约方案。',
      reserveTenjin: '预约天神店',
      reserveOgori: '预约小郡店',
      lineConsult: '微信咨询',
      reserve: '立即预约',
      ...
      hotpepper: 'HotPepper',
      pageTitle: {
        home: 'BISIN BEAUTY | Coolspa 冻脂 & 美甲沙龙',
  ...
  var japaneseToChineseCopy = [
    ...
    ['脂肪冷却は回数を重ねながら、約1ヶ月かけてラインの変化を見ていく施術です。温めてから冷却する流れで、夏前のサイズダウン相談にもおすすめです。', '冻脂适合持续护理，通常会在约1个月左右观察线条变化。先温热再冷冻，也适合夏天前想管理尺寸的人。'],
    ['冻脂は回数を重ねながら、約1ヶ月かけてラインの変化を見ていく施術です。温めてから冷却する流れで、夏前のサイズダウン相談にもおすすめです。', '冻脂适合持续护理，通常会在约1个月左右观察线条变化。先温热再冷冻，也适合夏天前想管理尺寸的人。'],
    ['4回後', '4次后'],
    ['100cup', '100杯'],
    ['チャレンジ経過', '挑战经过'],
    ...
    ['サウナ×冷却', '桑拿×冷冻'],
    ['サウナドームで温まってから脂肪冷却を受ける流れが心地よく、発汗や身体の軽さも好評。', '先用桑拿舱温热身体，再进行冻脂，整体流程舒适，出汗感和身体轻盈感也很受好评。'],
    ...
    ['「ネイルと脂肪冷却を同じ日にできて、時間の節約になりました。スタッフさんも気さくで話しやすい。」', '“美甲和冻脂可以安排在同一天，节省了很多时间。工作人员也很亲切，沟通起来很轻松。”'],
    ['「ネイルと冻脂を同じ日にできて、時間の節約になりました。スタッフさんも気さくで話しやすい。」', '“美甲和冻脂可以安排在同一天，节省了很多时间。工作人员也很亲切，沟通起来很轻松。”'],
    ...
    ['脂肪冷却 ／ 3ヶ月通い中', '冻脂 / 持续护理3个月'],
    ['脂肪冷却 ／ 半年以上通い中', '冻脂 / 持续护理半年以上'],
    ['脂肪冷却 ／ 2ヶ月通い中', '冻脂 / 持续护理2个月'],
    ['ネイル＋脂肪冷却 ／ 通い中', '美甲＋冻脂 / 持续护理中'],
    ['ネイル＋冻脂 ／ 通い中', '美甲＋冻脂 / 持续护理中'],
    ['脂肪冷却 ／ 4ヶ月通い中', '冻脂 / 持续护理4个月'],
    ['ネイル ／ リピート中', '美甲 / 持续复购中'],
    ['30代女性', '30多岁女性'],
    ['40代女性', '40多岁女性'],
    ['予約前チェック', '预约前确认'],
    ['口コミ・症例を見てから、納得して予約できます。', '先看顾客评价和案例，再安心预约。'],
    ['初めての脂肪冷却で不安になりやすい「痛み」「説明の丁寧さ」「効果時期」を、HotPepperの声と症例写真で先に確認できる導線にしました。', '第一次做冻脂时，很多人会担心痛感、说明是否细致、效果出现时间。这里可以先通过 HotPepper 的评价和案例照片确认，再决定是否预约。'],
    ['初めての冻脂で不安になりやすい「痛み」「説明の丁寧さ」「効果時期」を、HotPepperの声と症例写真で先に確認できる導線にしました。', '第一次做冻脂时，很多人会担心痛感、说明是否细致、效果出现时间。这里可以先通过 HotPepper 的评价和案例照片确认，再决定是否预约。'],
    ['説明が丁寧', '说明细致'],
    ['無理な勧誘なし', '无强推'],
    ['勧誘一切なし', '无强推'],
    ['痛みへの配慮', '会照顾痛感'],
    ...
    ['施術', '护理'],
    ['サウナドームで温め、脂肪冷却へ。冷たさや吸引感は声をかけながら調整します。', '先用桑拿舱温热身体，再进行冻脂。冷感和吸附感会一边沟通一边调整。'],
    ['サウナドームで温め、冻脂へ。冷たさや吸引感は声をかけながら調整します。', '先用桑拿舱温热身体，再进行冻脂。冷感和吸附感会一边沟通一边调整。'],
    ['アフター案内', '护理后说明'],
    ...
    ['男性の相談', '男性咨询'],
    ['お腹・背中・腰まわりなど、男性の脂肪冷却相談にも対応しています。', '腹部、背部、腰周等男性冻脂咨询也可以对应。'],
    ['お腹・背中・腰まわりなど、男性の冻脂相談にも対応しています。', '腹部、背部、腰周等男性冻脂咨询也可以对应。'],
    ...
    ['初めてで迷う場合は、まず気になる部位を基準に選んでください。お試しなら1CUP/2CUP、見た目の変化を狙うならサウナ×脂肪冷却4cup、複数部位なら8cupがおすすめです。当日のカウンセリングで調整できます。', '第一次不确定时，可以先按在意部位来选。想试试看可选1CUP/2CUP，想看外观变化推荐桑拿×冻脂4cup，多个部位可咨询8cup。当日咨询时也可以调整。'],
    ['初めてで迷う場合は、まず気になる部位を基準に選んでください。お試しなら1CUP/2CUP、見た目の変化を狙うならサウナ×冻脂4cup、複数部位なら8cupがおすすめです。当日の咨询で調整できます。', '第一次不确定时，可以先按在意部位来选。想试试看可选1CUP/2CUP，想看外观变化推荐桑拿×冻脂4cup，多个部位可咨询8cup。当日咨询时也可以调整。'],
    ['男性も予約できますか？', '男性也可以预约吗？'],
    ['男性も预约できますか？', '男性也可以预约吗？'],
    ['はい、男性のお腹・背中・腰まわりの相談も受け付けています。店舗やメニューにより対応範囲が異なるため、事前にご相談ください。', '可以。男性腹部、背部、腰周等咨询也可对应。不同店铺和菜单的对应范围可能不同，建议先微信确认。'],
    ['はい。お腹・背中・腰まわりなど、男性の脂肪冷却相談にも対応しています。症例写真を見ながら、気になる部位に合わせてご案内します。', '可以。腹部、背部、腰周等男性冻脂咨询也可对应。可以一边参考案例照片，一边根据您在意的部位说明。'],
    ['はい。お腹・背中・腰まわりなど、男性の冻脂相談にも対応しています。症例写真を見ながら、気になる部位に合わせてご案内します。', '可以。腹部、背部、腰周等男性冻脂咨询也可对应。可以一边参考案例照片，一边根据您在意的部位说明。'],
    ['はい。腹部、背部、腰周等男性冻脂咨询也可以对应。症例写真を見ながら、気になる部位に合わせてご案内します。', '可以。腹部、背部、腰周等男性冻脂咨询也可对应。可以一边参考案例照片，一边根据您在意的部位说明。'],
    ...
    ['可愛い系から大人上品デザインまで、日常に馴染む美しさをご提案。季節ごとの新デザイン提案も充実。脂肪冷却と同日の施術も可能です。', '从可爱风到成熟精致款，都能贴近日常风格。也会提供季节新款建议，可与冻脂安排在同一天。'],
    ['可愛い系から大人精致设计まで、日常に馴染む美しさをご提案。季節ごとの新设计提案も充実。冻脂と同日护理もOK。', '从可爱风到成熟精致款，都能贴近日常风格。也会提供季节新款建议，可与冻脂安排在同一天。'],
    ['冻脂と同日护理もOK。', '也可以和冻脂安排在同一天。'],
    ['サービス・料金 服务・价格 冻脂と美甲の全メニューをご紹介します。第一次来店的顾客でもわかりやすい価格設計で、まずはお気軽にご体験ください。', '服务・价格。这里介绍冻脂和美甲的全部菜单。第一次来店也能看懂价格，欢迎轻松体验。'],
    ['冻脂とは 特定の温度で脂肪细胞に直接アプローチする、メスを使わない非侵襲的な瘦身ケア。食事制限・无需高强度运动で、気になる部位のラインを整えます。', '冻脂是什么：用特定温度针对脂肪细胞进行护理，不动刀、非侵入式。无需节食和高强度运动，帮助整理在意部位的线条。'],
    ['食事制限なしで、気になる部位を集中ケア。', '无需节食，集中护理在意部位。'],
    ['无需节食で、気になる部位を集中ケア。', '无需节食，集中护理在意部位。'],
    ['脂肪冷却でお腹・腰まわり・太ももにアプローチ。天神COOL SPAと小郡CHUCHUで、初めての方も予約しやすい体験メニューをご用意しています。', '通过冻脂护理腹部、腰周和大腿。天神 COOL SPA 与小郡 CHUCHU 都准备了第一次也容易预约的体验菜单。'],
    ['冻脂で腹部・腰周・大腿にアプローチ。天神COOL SPAと小郡CHUCHUで、第一次来店的顾客も预约しやすい体験メニューを已经为您准备好。', '通过冻脂护理腹部、腰周和大腿。天神 COOL SPA 与小郡 CHUCHU 都准备了第一次也容易预约的体验菜单。'],
    ...
    ['天神は冻脂メインの結果重視サロン、小郡は美甲も楽しめるトータルビューティーサロン。ご希望の雰囲気に合わせてお選びいただけます。', '天神店主打冻脂和效果，小郡店则是可同时享受美甲的综合美容沙龙。可以按喜欢的氛围选择。'],
    ...
    ['あなたのビジネスを、ゼロから一緒に。', '从零开始，和你一起打造事业。'],
    ['脂肪冷却サロンの開業から、Webサイト制作・AI活用・マーケティング支援まで。BISINが経営のあらゆる場面でパートナーとして伴走します。', '从冻脂沙龙开业，到网站制作、AI 活用和营销支持，BISIN 会在经营的各个阶段陪跑。'],
    ['冻脂沙龙の開業から、Webサイト制作・AI活用・マーケティング支援まで。BISINが経営のあらゆる場面でパートナーとして陪跑支持します。', '从冻脂沙龙开业，到网站制作、AI 活用和营销支持，BISIN 会在经营的各个阶段陪跑。'],
  ...
  function cleanupResidualJapaneseForChinese(text) {
    ...
    return text
      ...
      .replace(/可爱风成熟精致设计、日常自然融入美感建议。季节新设计建议丰富。冻脂同日护理OK。/g, '从可爱风到成熟精致款，都能贴近日常风格。也会提供丰富的季节新款建议，可与冻脂安排在同一天。')
      .replace(/美甲服务小郡店可以对应。冻脂组合、同日护理可以。/g, '美甲服务由小郡店提供，也可以和冻脂安排在同一天。')
      .replace(/\s{2,}/g, ' ')
      .trim();
  }
